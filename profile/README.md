...
![환자 정보 관리](../assets/patientdashboard.gif)

---

### 3. 간호 기록

- **간호기록 작성(리치 텍스트 에디터 - 형광펜/글자색)**
- **간호기록 조회 및 수정**

![간호기록](../assets/nursingrecord.gif)
